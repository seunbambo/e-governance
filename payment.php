                            ...
                            <form class="form-register mx-auto" action="" method="post">
                                ...
                                <div id="form-total">
                                        ...
                                        <div class='row'>
                                            <div class='col-lg-12'>
                                                <div class="form-group">
                                                    <label for="email"><b>Holder's Name</b><i class="fa text-warning">*</i></label> <input type="text" class="form-control input" id="holder" name="holder" value="" autocomplete="off" placeholder="Card Owner's Name" required>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-holder form-holder-2 pull-right">
                                        <a class="btn btn-info" style="border-radius: 0px;" href="certificate-pdf.php">Confirm
                                        </a>
                                    </div>
                                    <!-- </section> -->
                                </div>
