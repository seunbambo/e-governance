...
<section style="padding-top: 30px; background: #BF0A30; background-image: url('images/logo4.png'); background-position: center;
  ...
  background-attachment: fixed; width: 100%; position:absolute;">
    <div class="" style="width: 100%;">
        ...
        <div class="jumbotron jumbotron-fluid text-center">
            ...
            <h3 class="text-center mt-1 mb-3" style="padding-top: 30px; color: #fff;">Popular Services</h3>
